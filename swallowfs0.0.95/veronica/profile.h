...
//计算块XOR结果
extern int profile_XOR_CHUNKBLOCK_CHUNK_DATA(CHUNK *tarchunkptr,CHUNKBLOCKGROUP *chunkblkgroup);
extern int profile_XOR_CHUNKBLOCK_CHUNK_DATA_XOR(CHUNK *tarchunkptr,CHUNKBLOCKGROUP *chunkblkgroup);
