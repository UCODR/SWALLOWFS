...
xlswrite('minchunkvalue.xls',minchunkvalue);
xlswrite('maxchunkvalue',maxchunkvalue);
xlswrite('avgchunkvalue',avgchunkvalue);
xlswrite('minupdatevalue',minupdatevalue);
xlswrite('maxupdatevalue',maxupdatevalue);
xlswrite('avgupdatevalue',avgupdatevalue);
